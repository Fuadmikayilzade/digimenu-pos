...
export default function ReportsPage() {
  ...
  // Topbar-dakı filial seçimi ilə heç bağlı deyildi. İndi qlobal
  // `activeBranchId`-ə tabedir (bax: DashboardPage.jsx-də eyni düzəliş):
  const { user, paidOrders, orders, todaySales, menuItems, activeBranchId, branches } = useApp()
  ...
  // VƏ 'manager' (menecer) tamamilə İSTİSNA edilirdi:
  if (!can(user, 'reports')) {
    return (
