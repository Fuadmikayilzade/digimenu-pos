      ...
      <div className="modal">
        ...
        <div className="pay-methods">
          {[
            ...
            // ⚠️ Əvvəllər "QR" adlanırdı — indi onlayn ödəniş sistemi
            // tam işlək olduğu üçün bu seçim "kassir bunu ƏL İLƏ,
            // müştəri artıq ÖZÜ onlayn ödədiyini təsdiqləmək üçün"
            // istifadə edir (məs. sistem avtomatik aşkarlamamışsa):
            { k: 'online', icon: '🌐', label: 'Müştəri özü ödədi' },
          ].map(m => (
        ...
        {method === 'online' && (
          <div style={{ textAlign: 'center', padding: '14px 0', color: 'var(--gray)', fontSize: '12px' }}>
            🌐 Müştəri hesabı onlayn özü ödədi — bu, sadəcə qeydiyyatdır
          </div>
        )}
